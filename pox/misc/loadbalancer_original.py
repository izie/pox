...
virtual_mac = EthAddr("00:00:00:00:00:FE")

server = {}
server[0] = {'ip':IPAddr("10.0.0.1"), 'mac':EthAddr("00:00:00:00:00:01"), 'outport': 1}
server[1] = {'ip':IPAddr("10.0.0.2"), 'mac':EthAddr("00:00:00:00:00:02"), 'outport': 2}
server[2] = {'ip':IPAddr("10.0.0.3"), 'mac':EthAddr("00:00:00:00:00:03"), 'outport': 3}
